...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        # self.x = np.matrix([pos_veh[0]], [pos_veh[1]], [pos_veh[2]], [0.], [0.], [0.])
        ...
        for i in unassigned_tracks:
            ...
            if meas_list: # if not empty
                if meas_list[0].sensor.in_fov(track.x):
                    # your code goes here 
                    track.score -= .5/params.window # decrease track score
                    

        # delete old tracks   
        to_remove = []
        for i in range(len(self.track_list)):       #see Udacity Knowledge as reference and because of Error: ValueError: list.remove(x): x not in list (see also: https://stackoverflow.com/questions/14126726/python-throws-valueerror-list-removex-x-not-in-list)
            track = self.track_list[i]
            ...
            elif track.score < 0.5/params.window:
                to_remove.append(track)
