...
def create_model(configs):
    ...
    if (configs.arch == 'darknet') and (configs.cfgfile is not None):
        ...
        model = fpn_resnet.get_pose_net(num_layers = 18, heads = configs.heads, 
                                        ...
                                        imagenet_pretrained = configs.imagenet_pretrained) #See into resnet/models/fpn_resnet.py
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        if 'darknet' in configs.arch:
            ...
            #See tools/objdet_models/resnet/utils/evaluation_utils.py and SFA3D -> test.py
